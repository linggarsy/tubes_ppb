...
class BaseLatihanPage extends StatelessWidget {
  final String hariKe;
  final List<Map<String, dynamic>> daftarLatihan;

  const BaseLatihanPage({
    super.key,
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 50,
            decoration: BoxDecoration(
              color: Color(0xFFCF0F0F).withOpacity(0.2),
                ...
                ? ClipRRect(
                    ...
                    child: Image.asset(
                      ...
                      errorBuilder: (context, error, stackTrace) {
                        return Icon(icon, color: Colors.blue, size: 30);
                      },
                    ),
                  )
                : Icon(icon, color: Color(0xFFCF0F0F), size: 30),
          ),
         SizedBox(width: 16),
          Expanded(
            child: Column(
